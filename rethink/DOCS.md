...
All course-setting selects accept commands only while the appliance reports Initial. Outside Initial,
their discovery option lists narrow to the appliance-reported value so the current state remains
