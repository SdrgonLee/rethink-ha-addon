...
node /usr/local/lib/rethink/config-generator.mjs "${OPTIONS_FILE}" "${CONFIG_FILE}"
...
echo "Starting Rethink revision 3046cd6b63f9b19190b6c29d41b543cf1b7d0899"
echo "Config: ${CONFIG_FILE}"
echo "Host: ${hostname}; HTTPS: ${https_port}; MQTTS: ${mqtts_port}; management: ${management_port}"
echo "SNI certificates: ${sni}; preserve existing devices: ${preserve}"
