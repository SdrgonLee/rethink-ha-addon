...
test('metadata and Dockerfile retain required safety settings and pins', () => {
    ...
    assert.match(config, /version: '0\.1\.21'/)
    assert.match(config, /^image: ghcr\.io\/sdrgonlee\/rethink-ha-addon$/m)
    assert.match(dockerfile, /BUILD_VERSION="0\.1\.21"/)
    assert.match(dockerfile, /RETHINK_REV="86aa5530103b5178ed91beaf3168a6e8e81e3583"/)
