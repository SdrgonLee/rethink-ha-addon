...
test('metadata and Dockerfile retain required safety settings and pins', () => {
    ...
    assert.match(config, /version: '0\.1\.16'/)
    assert.match(dockerfile, /BUILD_VERSION="0\.1\.16"/)
    assert.match(dockerfile, /RETHINK_REV="ccfac67ad79d5e9d3791eb0c23e11ecb738c1b04"/)
