...
test('metadata and Dockerfile retain required safety settings and pins', () => {
    ...
    assert.match(config, /version: '0\.1\.17'/)
    assert.match(dockerfile, /BUILD_VERSION="0\.1\.17"/)
    assert.match(dockerfile, /RETHINK_REV="8afc4604bdad00b87169a2502571515e3f5ad230"/)
