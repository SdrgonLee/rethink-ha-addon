...
test('metadata and Dockerfile retain required safety settings and pins', () => {
    ...
    assert.match(config, /version: '0\.1\.25'/)
    assert.match(config, /^image: ghcr\.io\/sdrgonlee\/rethink-ha-addon$/m)
    assert.match(dockerfile, /BUILD_VERSION="0\.1\.25"/)
    assert.match(dockerfile, /RETHINK_REV="200efcc90960be49e0f530387a2d9d2b7b59a8f9"/)
